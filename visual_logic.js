...
registerOnClick('Foto 1', false, false, [0,1,2], false, function(event) {
    tweenCamera('Cam 1', 'Foto 1', 1, function() {}, 0);
}, function(event) {});

registerOnClick('Foto 2', false, false, [0,1,2], false, function(event) {
    tweenCamera('Cam 2', 'Foto 2', 1, function() {}, 0);
}, function(event) {});

registerOnClick('Foto 3', false, false, [0,1,2], false, function(event) {
    tweenCamera('cam 3', 'Foto 3', 1, function() {}, 0);
}, function(event) {});

registerOnClick('Foto 4', false, false, [0,1,2], false, function(event) {
    tweenCamera('Cam 4', 'Foto 4', 1, function() {}, 0);
}, function(event) {});

registerOnClick('Foto 5', false, false, [0,1,2], false, function(event) {
    tweenCamera('Cam 5', 'Foto 5', 1, function() {}, 0);
}, function(event) {});

registerOnClick('Foto 6', false, false, [0,1,2], false, function(event) {
    tweenCamera('Cam 6', 'Foto 6', 1, function() {}, 0);
}, function(event) {});

registerOnClick('Foto 7', false, false, [0,1,2], false, function(event) {
    tweenCamera('Cam 7', 'Foto 7', 1, function() {}, 0);
}, function(event) {});

registerOnClick('Foto 8', false, false, [0,1,2], false, function(event) {
    tweenCamera('Cam 8', 'Foto 8', 1, function() {}, 0);
}, function(event) {});
